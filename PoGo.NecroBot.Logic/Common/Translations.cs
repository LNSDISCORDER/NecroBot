    ...
    public class Translation : ITranslation
    {
            ...
            <KeyValuePair<TranslationString, string>>
        {
            ...
            new KeyValuePair<TranslationString, string>(TranslationString.EventFortTargeted,
                "Traveling to {0}: {1} ({2}m) ({3} seconds)"),
            new KeyValuePair<TranslationString, string>(TranslationString.EventGymDiscovered,
                "{0} is being defended by team: {1}. with {2} pokemons"),
            new KeyValuePair<TranslationString, string>(TranslationString.EventGymDeployed,
                "Deployed pokemon: {0} (CP: {1}) to Gym: {2}"),
            new KeyValuePair<TranslationString, string>(TranslationString.EventGymDefending,
                "Defender: {0} (Level: {1}) Pokemon: {2} (CP: {3})"),
            new KeyValuePair<TranslationString, string>(TranslationString.EventUsedPotion,
                "Used {0}Potion on {1} (CP: {2}), remaining potions: {3}"),
            new KeyValuePair<TranslationString, string>(TranslationString.EventUsedRevive,
                 "Used {0}Revive on {1} (CP: {2}), remaining revives: {3}"),
            ...
            new KeyValuePair<TranslationString, string>(TranslationString.LogEntryPotion, "POTION"),
            new KeyValuePair<TranslationString, string>(TranslationString.LogEntryRevive, "REVIVE"),
            ...
            new KeyValuePair<TranslationString, string>(TranslationString.CurrentMiscItemInv,
                "Berries: {0} | Incense: {1} | LuckyEggs: {2} | Lures: {3} | Pokecoins: {4}"),
            new KeyValuePair<TranslationString, string>(TranslationString.CollectedPokecoins,
                "Collected {0} Pokecoins"),
